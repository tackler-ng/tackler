...
Tackler is in link:https://tackler.e257.fi/features/[feature] parity with
...
link:docs/devel/readme.adoc[Developer's Guides] have technical information about Tackler. For Tackler user manual, see the link:https://tackler.e257.fi/docs/[Tackler Documentation].
