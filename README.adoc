...
1) Tackler has excellent performance, it can process 900_000 transactions per second on modern laptop.
...
Tackler is reimplementation of 10 years old Scala based system (tackler-mk1),
and it's the only https://tackler.fi/docs/tackler/latest/governance/[supported version] of tackler.

Tackler is beyond link:https://tackler.fi/docs/tackler/latest/features/[feature] parity of the old Scala code base.
It's using the same foundation of test reference vectors as the original tackler-mk1.

[NOTE]
====
*Tackler is tested with 520
...
link:https://github.com/RagibHasin[RagibHasin] and
link:https://github.com/VrugteVlieg[VrugteVlieg]
