...
You have clone tackler source code with git submodules, 
as [tests vectors](https://github.com/tackler-ng/tackler-tests) are located in a separate repository.
...
# the binary will be located at 'target/release/tackler'
----

Or with plain cargo commands:
