...
=== Tackler release 26.08.1

==== New features and changes

New features:

* A new external id (`ext-id`) txn metadata item
  ** See xref:docs/tep/tep-1018.adoc[TEP-1018] and
     link:https://github.com/tackler-ng/tackler/issues/141[GH #141]

Changed functionality:

* Replaced `TxnData::from` with `TxnData::try_from`

==== Fixes

Fixes in this release:

* Missing optimization with cargo publish (b98dd62db33b91ece91a8d341639d6d6ae0943e5)

==== Development

Changed structure of test suite, and added reference vectors natively into tackler's repository. 
The main git-repositories used as test inputs are still located on separate submodule.
...
=== Tackler release 26.07.1

==== New features and changes

Tackler is over 25% faster than previous release,
thanks to optimizing journal parsing and validating code.

New features: None

Changed functionality:

* Register report (txt,json) shows posting comments, see fixes below

==== Fixes

Fixes in this release:

* Include posting comments to register report's txt and json formats
  (link:https://github.com/tackler-ng/tackler/issues/168[Issue #168])
...
|tackler-core | 0.17.0
|tackler-api  | 0.16.0
|tackler-rs   | 0.12.0 (No changes)
|===


'''

=== Tackler release 26.04.1
...
Changed functionality: None

==== Fixes
 
* Fixed account sorting order in reports with special case of numerical sub-accounts 
  (link:https://github.com/tackler-ng/tackler/issues/152[Issue 152])
** This is purely visual fix and doesn't affect any report results
* Updated `gix` dependecy: this fixes
link:https://github.com/GitoxideLabs/gitoxide/releases/tag/gix-v0.82.0[several vulnerabilities] in it.
** Tackler is especially impacted if victim opens untrusted git journal with vulnerable version
(link:https://github.com/GitoxideLabs/gitoxide/security/advisories/GHSA-x494-mj8g-cj27[GHSA-x494-mj8g-cj27]


==== Contributions

* Thanks link:https://github.com/VrugteVlieg[@VrugteVlieg] for contributing
the account export feature
(link:https://github.com/tackler-ng/tackler/pull/151[PR 151])!
 ...
 * Possible memory corruption caused by dependency in OOM situation
   ** rkyv via rust-decimal: link:https://rustsec.org/advisories/RUSTSEC-2026-0001.html[RUSTSEC-2026-0001]
...
** This adds support of link:https://toml.io/en/v1.1.0#inline-table[indented inline tables]
   for tackler configuration files
...
|tackler-core | 0.14.0
|tackler-api  | 0.13.0
|tackler-rs   | No changes (v0.11.0)
|===

'''


=== Tackler release 25.10.1
