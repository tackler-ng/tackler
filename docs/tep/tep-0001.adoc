...
See branch
link:https://github.com/tackler-ng/tackler/tree/tep-XXXX-SHORT-NAME/docs/tep/tep-XXXX.adoc[/tep-XXXX-SHORT-NAME]
...
This is more technical, lower-level description of this change.
