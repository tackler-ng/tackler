...
Open design Question (ODQ): https://github.com/tackler-ng/tackler/issues/158
...
however, tackler doesn't support balance assertions at the moment.
...
To support the above, it might be needed to define these time datatypes as string,
so that they could be parsed with existing machinery, if it get's too complicated
to support above natively with TOML.
link:https://github.com/tackler-ng/tackler/blob/b1b2db5c329426e8536147cb53705f7dccdf5765/tackler-core/src/parser/parts/timestamp.rs#L163[tackler-core / parser / parts / timestamp.rs: parse_timestamp]
...
Open Design Question: https://github.com/tackler-ng/tackler/issues/162
...
Open Design Question (ODQ): https://github.com/tackler-ng/tackler/issues/159
...
Open Design Question (ODQ): https://github.com/tackler-ng/tackler/issues/158
Open Design Question (ODQ): https://github.com/tackler-ng/tackler/issues/162
...
Open Design Question (ODQ): https://github.com/tackler-ng/tackler/issues/161
Open Design Question (ODQ): https://github.com/tackler-ng/tackler/issues/162
...
Open Desing Question (ODQ): https://github.com/tackler-ng/tackler/issues/160
...
* [ ] if `open` / `close` timeformat parsing is done with TOML + custom logic, then this must be tested
...
* [ ] e: Additional tests based on (ODQ): https://github.com/tackler-ng/tackler/issues/161
* [ ] e: if `open` / `close` timeformat parsing is done with TOML + custom logic, then this must be tested
